...
@TeleOp(name="Test firing speed", group="Linear OpMode")


 !!!!!!!!!!!!!!IMPORTANT!!!!!!!!!!!!!
               VVVVVVVV
    THIS IS IN ONBOTJAVA DO NOT EDIT THIS FILE IN ANDROID STUDIO
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            if(gamepad1.right_bumper){
                ...
                shooting1.setPower(0.0);
                shooting2.setPower(0.0);
            }
            /*
            lb - intake
            rb - outtake
